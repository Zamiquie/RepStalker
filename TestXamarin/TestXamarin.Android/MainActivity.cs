...
{
    [Activity(Label = "RepStalker", Icon = "@drawable/icon_android", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
